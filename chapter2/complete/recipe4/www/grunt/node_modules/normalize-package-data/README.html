<h1>normalize-package-data <a href="https://travis-ci.org/npm/normalize-package-data"><img src="https://travis-ci.org/npm/normalize-package-data.png?branch=master" alt="Build Status"></a></h1><p>normalize-package-data exports a function that normalizes package metadata. This data is typically found in a package.json file, but in principle could come from any source - for example the npm registry.</p>
...
<h2>License</h2><p>normalize-package-data is released under the <a href="http://opensource.org/licenses/MIT">BSD 2-Clause License</a>.<br>Copyright (c) 2013 Meryn Stol  </p>
