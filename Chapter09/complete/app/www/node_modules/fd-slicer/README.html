  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        ...
        <h1>fd-slicer</h1><p><a href="https://travis-ci.org/andrewrk/node-fd-slicer"><img src="https://travis-ci.org/andrewrk/node-fd-slicer.svg?branch=master" alt="Build Status"></a>
<a href="https://coveralls.io/r/andrewrk/node-fd-slicer"><img src="https://img.shields.io/coveralls/andrewrk/node-fd-slicer.svg" alt="Coverage Status"></a></p>
...
<h2>Usage</h2><pre><code class="language-js">var fdSlicer = require(&#39;fd-slicer&#39;);
var fs = require(&#39;fs&#39;);
...
<pre><code class="language-js">var fdSlicer = require(&#39;fd-slicer&#39;);
...
<h2>API Documentation</h2><h3>fdSlicer.createFromFd(fd, [options])</h3><pre><code class="language-js">var fdSlicer = require(&#39;fd-slicer&#39;);
fs.open(&quot;file.txt&quot;, &#39;r&#39;, function(err, fd) {
  if (err) throw err;
  var slicer = fdSlicer.createFromFd(fd);
  // ...
...
<h3>fdSlicer.createFromBuffer(buffer)</h3><pre><code class="language-js">var fdSlicer = require(&#39;fd-slicer&#39;);
var slicer = fdSlicer.createFromBuffer(someBuffer);
// ...
</code></pre>
<h4>Properties</h4><h5>fd</h5><p>The file descriptor passed in. <code>undefined</code> if created from a buffer.</p>
<h4>Methods</h4><h5>createReadStream(options)</h5><p>Available <code>options</code>:</p>
<ul>
...
<h5>createWriteStream(options)</h5><p>Available <code>options</code>:</p>
<ul>
...
<h5>read(buffer, offset, length, position, callback)</h5><p>Equivalent to <code>fs.read</code>, but with concurrency protection.
<code>callback</code> must be defined.</p>
<h5>write(buffer, offset, length, position, callback)</h5><p>Equivalent to <code>fs.write</code>, but with concurrency protection.
<code>callback</code> must be defined.</p>
<h5>ref()</h5><p>Increase the <code>autoClose</code> reference count by 1.</p>
<h5>unref()</h5><p>Decrease the <code>autoClose</code> reference count by 1.</p>
<h4>Events</h4><h5>&#39;error&#39;</h5><p>Emitted if <code>fs.close</code> returns an error when auto closing.</p>
<h5>&#39;close&#39;</h5><p>Emitted when fd-slicer closes the file descriptor due to <code>autoClose</code>. Never
