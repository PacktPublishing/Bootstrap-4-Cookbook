...
<h1>Install</h1><pre><code>npm install dashdash
</code></pre><h1>Usage</h1><pre><code class="language-javascript">var dashdash = require(&#39;dashdash&#39;);
...
<h1>Longer Example</h1><p>A more realistic <a href="./examples/foo.js">starter script &quot;foo.js&quot;</a> is as follows.
...
# opts: { verbose: [ true, true, true ],
  ...
  _args: [] }
# args: []
</code></pre><p>See the <a href="examples/">&quot;examples&quot;</a> dir for a number of starter examples using
some of dashdash&#39;s features.</p>
<h1>Environment variable integration</h1><p>If you want to allow environment variables to specify options to your tool,
...
options:
    ...
    -f FILE, --file=FILE  File to process
</code></pre><h1>Bash completion</h1><p>Dashdash provides a simple way to create a Bash completion file that you
...
</code></pre><p>or directly from a <code>options</code> array of options specs:</p>
<pre><code>var code = dashdash.bashCompletionFromOptions({
    name: &#39;mycli&#39;,
    options: OPTIONS
});
</code></pre><p>Write that content to &quot;/usr/local/etc/bash_completion.d/mycli&quot; and you will
...
<h1>Parser config</h1><p>Parser construction (i.e. <code>dashdash.createParser(CONFIG)</code>) takes the
following fields:</p>
<ul>
...
</code></pre><p>Set it to false to have &#39;-h&#39; <strong>not</strong> get parsed as an option in the above
example.</p>
</li>
...
</code></pre><p>Set it to true to treat the unknown option as a positional
argument.</p>
...
</code></pre><p>where <code>-x</code> and <code>-z</code> are unknown.  There are multiple ways to
interpret this:</p>
<ol>
...
<h1>Option specs</h1><p>Example using all fields (required fields are noted):</p>
<pre><code class="language-javascript">{
...
<pre><code>  var options = [{names: [&#39;dry-run&#39;, &#39;n&#39;], env: &#39;FOO_DRY_RUN&#39;}];
  var opts = dashdash.parse({options: options});
</code></pre><p>Both <code>node foo.js --dry-run</code> and <code>FOO_DRY_RUN=1 node foo.js</code> would result
...
<li><p><code>help</code> (String). Optional. Used for <code>parser.help()</code> output.</p>
</li>
...
<h1>Option group headings</h1><p>You can add headings between option specs in the <code>options</code> array.  To do so,
...
<h1>Help config</h1><p>The <code>parser.help(...)</code> function is configurable as follows:</p>
<pre><code>    Options:
      Armament Options:
...
<h1>Custom option types</h1><p>Dashdash includes a good starter set of option types that it will parse for
...
</code></pre><p>For example, a simple option type that accepts &#39;yes&#39;, &#39;y&#39;, &#39;no&#39; or &#39;n&#39; as
...
var opts = dashdash.parse({options: options});
</code></pre><p>See &quot;examples/custom-option-*.js&quot; for other examples.
...
<h1>Why</h1><p>Why another node.js option parsing lib?</p>
<ul>
...
<h1>License</h1><p>MIT. See LICENSE.txt.</p>
