  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        ...
        <h1>asynckit <a href="https://www.npmjs.com/package/asynckit"><img src="https://img.shields.io/npm/v/asynckit.svg?style=flat" alt="NPM Module"></a></h1><p>Minimal async jobs utility library, with streams support.</p>
...
<h2>Install</h2><pre><code class="language-sh">$ npm install --save asynckit
</code></pre>
<h2>Examples</h2><h3>Parallel Jobs</h3><p>Runs iterator over provided array in parallel. Stores output in the <code>result</code> array,
on the matching positions. In unlikely event of an error from one of the jobs,
will terminate rest of the active jobs (if abort function is provided)
and return error along with salvaged data to the main callback function.</p>
<h4>Input Array</h4><pre><code class="language-javascript">var parallel = require(&#39;asynckit&#39;).parallel
...
<h4>Input Object</h4><p>Also it supports named jobs, listed via object.</p>
...
<h3>Serial Jobs</h3><p>Runs iterator over provided array sequentially. Stores output in the <code>result</code> array,
on the matching positions. In unlikely event of an error from one of the jobs,
will not proceed to the rest of the items in the list
and return error along with salvaged data to the main callback function.</p>
<h4>Input Array</h4><pre><code class="language-javascript">var serial = require(&#39;asynckit/serial&#39;)
  , assert = require(&#39;assert&#39;)
  ;
...
<p>_Note: Since <em>object</em> is an <em>unordered</em> collection of properties,
it may produce unexpected results with sequential iterations.
Whenever order of the jobs&#39; execution is important please use <code>serialOrdered</code> method._</p>
<h3>Ordered Serial Iterations</h3><p>TBD</p>
<p>For example <a href="compare-property">compare-property</a> package.</p>
<h3>Streaming interface</h3><p>TBD</p>
<h2>Want to Know More?</h2><p>More examples can be found in <a href="test/">test folder</a>.</p>
<p>Or open an <a href="https://github.com/alexindigo/asynckit/issues">issue</a> with questions and/or suggestions.</p>
<h2>License</h2><p>AsyncKit is licensed under the MIT license.</p>
