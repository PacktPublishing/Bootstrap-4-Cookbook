  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        ...
        <p><img src="https://raw.githubusercontent.com/caolan/async/master/logo/async-logo_readme.jpg" alt="Async Logo"></p>
...
<a href="https://www.libhive.com/providers/npm/packages/async"><img src="https://www.libhive.com/providers/npm/packages/async/examples/badge.svg" alt="libhive - Open source examples"></a></p>
<p>Async is a utility module which provides straight-forward, powerful functions for working with asynchronous JavaScript. Although originally designed for use with <a href="https://nodejs.org/">Node.js</a> and installable via <code>npm install --save async</code>, it can also be used directly in the browser.</p>
<p>For Documentation, visit <a href="http://caolan.github.io/async/">http://caolan.github.io/async/</a></p>
