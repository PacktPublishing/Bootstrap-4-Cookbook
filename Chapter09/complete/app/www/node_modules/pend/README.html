  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        ...
        <h1>Pend</h1><p>Dead-simple optimistic async helper.</p>
<h2>Usage</h2><pre><code class="language-js">var Pend = require(&#39;pend&#39;);
var pend = new Pend();
...
<p>Output:</p>
<pre><code>this function is immediately executed
