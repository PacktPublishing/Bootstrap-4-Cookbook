  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        ...
        <h1>sprintf.js</h1><p><strong>sprintf.js</strong> is a complete open source JavaScript sprintf implementation for the <em>browser</em> and <em>node.js</em>.</p>
<p>Its prototype is simple:</p>
<pre><code>string sprintf(string format , [mixed arg1 [, mixed arg2 [ ,...]]])
</code></pre><p>The placeholders in the format string are marked by <code>%</code> and are followed by one or more of these elements, in this order:</p>
<ul>
...
<h2>JavaScript <code>vsprintf</code></h2><p><code>vsprintf</code> is the same as <code>sprintf</code> except that it accepts an array of arguments, rather than a variable number of arguments:</p>
<pre><code>vsprintf(&quot;The first 4 letters of the english alphabet are: %s, %s, %s and %s&quot;, [&quot;a&quot;, &quot;b&quot;, &quot;c&quot;, &quot;d&quot;])
</code></pre><h2>Argument swapping</h2><p>You can also swap the arguments. That is, the order of the placeholders doesn&#39;t have to match the order of the arguments. You can do that by simply indicating in the format string which arguments the placeholders refer to:</p>
...
<h2>Named arguments</h2><p>Format strings may contain replacement fields rather than positional placeholders. Instead of referring to a certain argument, you can now refer to a certain key within an object. Replacement fields are surrounded by rounded parentheses - <code>(</code> and <code>)</code> - and begin with a keyword that refers to a key:</p>
<pre><code>var user = {
    name: &quot;Dolly&quot;
}
sprintf(&quot;Hello %(name)s&quot;, user) // Hello Dolly
</code></pre><p>Keywords in replacement fields can be optionally followed by any number of keywords or indexes:</p>
<pre><code>var users = [
    {name: &quot;Dolly&quot;},
    {name: &quot;Molly&quot;},
    {name: &quot;Polly&quot;}
...
</code></pre><p>Note: mixing positional and named placeholders is not (yet) supported</p>
<h2>Computed values</h2><p>You can pass in a function as a dynamic value and it will be invoked (with no arguments) in order to compute the value on-the-fly.</p>
<pre><code>sprintf(&quot;Current timestamp: %d&quot;, Date.now) // Current timestamp: 1398005382890
sprintf(&quot;Current date and time: %s&quot;, function() { return new Date().toString() })
</code></pre><h1>AngularJS</h1><p>You can now use <code>sprintf</code> and <code>vsprintf</code> (also aliased as <code>fmt</code> and <code>vfmt</code> respectively) in your AngularJS projects. See <code>demo/</code>.</p>
<h1>Installation</h1><h2>Via Bower</h2><pre><code>bower install sprintf
</code></pre><h2>Or as a node.js module</h2><pre><code>npm install sprintf-js
</code></pre><h3>Usage</h3><pre><code>var sprintf = require(&quot;sprintf-js&quot;).sprintf,
    vsprintf = require(&quot;sprintf-js&quot;).vsprintf

sprintf(&quot;%2$s %3$s a %1$s&quot;, &quot;cracker&quot;, &quot;Polly&quot;, &quot;wants&quot;)
vsprintf(&quot;The first 4 letters of the english alphabet are: %s, %s, %s and %s&quot;, [&quot;a&quot;, &quot;b&quot;, &quot;c&quot;, &quot;d&quot;])
</code></pre><h1>License</h1><p><strong>sprintf.js</strong> is licensed under the terms of the 3-clause BSD license.</p>
