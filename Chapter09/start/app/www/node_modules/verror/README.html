  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        ...
        <h1>verror: richer JavaScript errors</h1><p>This module provides two classes: VError, for accretive errors, and WError, for
wrapping errors.  Both support printf-style error messages using extsprintf.</p>
<h2>Printf-style errors</h2><p>At the most basic level, VError is just like JavaScript&#39;s Error class, but with
...
</code></pre><h2>VError for accretive error messages</h2><p>More interestingly, you can use VError to build up an error describing what
...
</code></pre><p>Since the file &quot;/nonexistent&quot; doesn&#39;t exist, this prints out:</p>
<pre><code>request failed: failed to check &quot;/nonexistent&quot;: ENOENT, stat &#39;/nonexistent&#39;
</code></pre><p>The idea here is that the lowest level (Node&#39;s &quot;fs.stat&quot; function) generates an
...
</code></pre><h2>WError for wrapped errors</h2><p>Sometimes you don&#39;t want an Error&#39;s &quot;message&quot; field to include the details of
...
</code></pre><p>That&#39;s what we wanted -- just a high-level summary for the client.  But we can
...
</code></pre><h1>Contributing</h1><p>Contributions welcome.  Code should be &quot;make check&quot; clean.  To run &quot;make check&quot;,
