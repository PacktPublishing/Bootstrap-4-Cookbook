  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        ...
        <h1>Form-Data <a href="https://www.npmjs.com/package/form-data"><img src="https://img.shields.io/npm/v/form-data.svg" alt="NPM Module"></a> <a href="https://gitter.im/form-data/form-data"><img src="http://form-data.github.io/images/gitterbadge.svg" alt="Join the chat at https://gitter.im/form-data/form-data"></a></h1><p>A library to create readable <code>&quot;multipart/form-data&quot;</code> streams. Can be used to submit forms and file uploads to other web applications.</p>
...
<p><a href="https://travis-ci.org/form-data/form-data"><img src="https://img.shields.io/travis/form-data/form-data/v1.0.1.svg?label=linux:0.10-6.x" alt="Linux Build"></a>
<a href="https://ci.appveyor.com/project/alexindigo/form-data"><img src="https://img.shields.io/appveyor/ci/alexindigo/form-data/v1.0.1.svg?label=windows:0.10-6.x" alt="Windows Build"></a>
<a href="https://coveralls.io/github/form-data/form-data?branch=master"><img src="https://img.shields.io/coveralls/form-data/form-data/v1.0.1.svg?label=code+coverage" alt="Coverage Status"></a></p>
...
<h2>Install</h2><pre><code>npm install --save form-data
</code></pre><h2>Usage</h2><p>In this example we are constructing a form with 3 fields that contain a string,
...
<h3>Alternative submission methods</h3><p>You can use node&#39;s http client interface:</p>
...
<h3>Integration with other libraries</h3><h4>Request</h4><p>Form submission using  <a href="https://github.com/request/request">request</a>:</p>
...
<h4>node-fetch</h4><p>You can also submit a form using <a href="https://github.com/bitinn/node-fetch">node-fetch</a>:</p>
...
<li>If it feels like FormData hangs after submit, please check <a href="http://nodejs.org/api/stream.html#stream_compatibility_with_older_node_versions">Compatibility with Older Node Versions</a></li>
</ul>
<h2>License</h2><p>Form-Data is released under the <a href="License">MIT</a> license.</p>
