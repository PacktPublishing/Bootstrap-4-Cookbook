...
a parser.</p>
<p>The parser API is a function which receives a string &amp; returns a <a href="https://github.com/postcss/postcss/blob/master/docs/api.md#root-node"><code>Root</code></a> node.
...
<p>A parser should save all additional symbols to <a href="https://github.com/postcss/postcss/blob/master/docs/api.md#node-raws"><code>node.raws</code></a> object.
...
<p>A Stringifier is a function which receives <a href="https://github.com/postcss/postcss/blob/master/docs/api.md#root-node"><code>Root</code></a> node and builder callback.
...
<p>This is why every node has <a href="https://github.com/postcss/postcss/blob/master/docs/api.md#node-raws"><code>node.raws</code></a> object to store space symbol, etc.</p>
