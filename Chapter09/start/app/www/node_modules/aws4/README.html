  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        ...
        <h2>aws4</h2><p><a href="http://travis-ci.org/mhart/aws4"><img src="https://secure.travis-ci.org/mhart/aws4.png?branch=master" alt="Build Status"></a></p>
...
<h2>Example</h2><pre><code class="language-javascript">var http  = require(&#39;http&#39;),
    https = require(&#39;https&#39;),
    aws4  = require(&#39;aws4&#39;)
...
<h2>More options</h2><pre><code class="language-javascript">// you can also pass AWS credentials in explicitly (otherwise taken from process.env)
...
<h2>API</h2><h3>aws4.sign(requestOptions, [credentials])</h3><p>This calculates and populates the <code>Authorization</code> header of
...
</code></pre><p>(will also use <code>AWS_ACCESS_KEY</code> and <code>AWS_SECRET_KEY</code> if available)</p>
...
</code></pre><p>Can also be used <a href="./browser">in the browser</a>.</p>
<h2>Thanks</h2><p>Thanks to <a href="https://github.com/jed">@jed</a> for his
