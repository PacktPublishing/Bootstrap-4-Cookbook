<h2>Pure JS character encoding conversion <a href="https://travis-ci.org/ashtuchkin/iconv-lite"><img src="https://travis-ci.org/ashtuchkin/iconv-lite.svg?branch=master" alt="Build Status"></a></h2><ul>
...
<h2>Usage</h2><h3>Basic API</h3><pre><code class="language-javascript">var iconv = require(&#39;iconv-lite&#39;);
...
<h3>Streaming API (Node v0.10+)</h3><pre><code class="language-javascript">
...
<h3>[Deprecated] Extend Node.js own encodings</h3><blockquote>
...
<h2>Encoding/decoding speed</h2><p>Comparison with node-iconv module (1000x256kb, on MacBook Pro, Core i5/2.6 GHz, Node v0.12.0). 
...
</code></pre><h2>BOM handling</h2><ul>
...
<h2>UTF-16 Encodings</h2><p>This library supports UTF-16LE, UTF-16BE and UTF-16 encodings. First two are straightforward, but UTF-16 is trying to be
...
<h2>Adoption</h2><p><a href="https://nodei.co/npm/iconv-lite/"><img src="https://nodei.co/npm-dl/iconv-lite.png" alt="NPM"></a>
